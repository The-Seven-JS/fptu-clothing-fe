...
function Other() {
  ...
  return (
    <div>
      ...
      /> */}
      <Link to={'/knowledge/other/id4'} style={{textDecoration:'none'}}>
      ...
      <Link to={'/knowledge/other/id1'} style={{textDecoration:'none'}}>
      ...
      <Link to={'/knowledge/other/id2'} style={{textDecoration:'none'}}>
      ...
      <Link to={'/knowledge/other/id3'} style={{textDecoration:'none'}}>
